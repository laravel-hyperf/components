 ...
 * @method static \Redis|array|string hRandField(string $key, array|null $options = null)
 * @method static \Redis|int|false hSet(string $key, string $member, mixed $value)
 * @method static \Redis|bool hSetNx(string $key, string $field, string $value)
 * @method static \Redis|int|false hStrLen(string $key, string $field)
 * @method static \Redis|array|false hVals(string $key)
 * @method static \Redis|array|bool hscan(string $key, int|null $iterator, string|null $pattern = null, int $count = 0)
 ...
 * @method static \Redis|array mget(array $keys)
 ...
 * @method static \Redis|array|string|false sRandMember(string $key, int $count = 0)
 ...
 * @method static array|false sscan(string $key, int|null $iterator, string|null $pattern = null, int $count = 0)
 ...
 * @method static \Redis|int|false zCount(string $key, string $start, string $end)
 ...
 * @method static \Redis|array|false zscan(string $key, int|null $iterator, string|null $pattern = null, int $count = 0)
