 ...
 * @method static \GuzzleHttp\ClientInterface getClient(?string $connection, HandlerStack $handlerStack, ?array $config = null)
 * @method static \GuzzleHttp\ClientInterface createClient(HandlerStack $handlerStack)
